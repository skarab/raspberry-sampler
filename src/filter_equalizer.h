...
{
    double low = pow(2.0, (params[PARAM_GLOBAL_EQLow])/10.0);
    double mid = pow(2.0, (params[PARAM_GLOBAL_EQMedium])/10.0);
    double high = pow(2.0, (params[PARAM_GLOBAL_EQHigh])/10.0);
