...
inline void FILTER_LOWPASS_ComputeChannel(double& value, double* inputs, double* outputs, double a1, double a2, double b1, double b2)
{
...
inline void FILTER_LOWPASS_Compute(double& left, double& right, const vector<int>& params, FILTER_LOWPASS& filter)
{
    ...
    FILTER_LOWPASS_ComputeChannel(left, filter.InputLeft, filter.OutputLeft, filter.A1, filter.A2, filter.B1, filter.B2);
    FILTER_LOWPASS_ComputeChannel(right, filter.InputRight, filter.OutputRight, filter.A1, filter.A2, filter.B1, filter.B2);
}
